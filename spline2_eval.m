...
bspline_x = bspline_v2( xs, nc_x, d, tx);
bspline_y = bspline_v2( ys, nc_y, d, ty);

if gridded
	z = bspline_x * reshape( c, [nc_y, nc_x])' * bspline_y';
else
	z = dot(bspline_x * reshape( c, [nc_y, nc_x])', bspline_y, 2);
	z = reshape(z, x_size);
end